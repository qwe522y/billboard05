...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Добавление нового влалельца рекламных точек
            </h1>
            <ol class="breadcrumb">
                        ...
                        <sf:form method="post" modelAttribute="owner" class="form-horizontal" action=".">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <sf:input path="name" id="nameField" type="text" placeholder="Ф.И.О." class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="phoneField">Телефон</label>
                                    <div class="col-sm-9">
                                        <sf:input path="phone" id="phoneField" type="text" placeholder="Телефон" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
